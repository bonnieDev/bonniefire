...
function enqueue_custom_styles() {
    ...
    wp_enqueue_style(
        'main-style', // Handle
        get_stylesheet_uri(), // Automatically points to style.css in the theme
        array(), // No dependencies
        '1.0', // Version
        'all' // Media type
    );
    
    // Enqueue the override.css file (loaded after main style.css)
    wp_enqueue_style(
        'override-style', // Handle
        get_stylesheet_directory_uri() . '/override.css', // File path
        array('main-style'), // Dependency: main style.css
        '1.0', // Version
        'all' // Media type
    );
}
