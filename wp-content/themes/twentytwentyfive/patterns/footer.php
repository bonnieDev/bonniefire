	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-group alignfull">
			...
			<div class="wp-block-group">
				<!-- wp:navigation {"overlayMenu":"never","layout":{"type":"flex","orientation":"vertical"}} -->
					<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Linkedin', 'twentytwentyfive' ); ?>","url":"https://www.linkedin.com/in/bonniefire/"} /-->


				<!-- /wp:navigation -->

				<!-- wp:navigation {"overlayMenu":"never","layout":{"type":"flex","orientation":"vertical"}} -->
					<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Home', 'twentytwentyfive' ); ?>","url":"#"} /-->
		...
		<div class="wp-block-group alignfull">
			...
			<p class="has-small-font-size">
				<?php
				printf(
					/* translators: A customized Wordpress theme by Bonnie. %s: WordPress link. */
					esc_html__( 'A customized Wordpress theme by Bonnie.', 'twentytwentyfive' ),
